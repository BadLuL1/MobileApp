...
public class CElectronic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_celectronic);
    ...
    public void getProducts(){
        ...
        recyclerView = findViewById(R.id.rcv_electronic);
        database = db.getReference("CElectronic");
