...
public class CPersonalCare extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cpersonal_care);
    ...
    public void getProducts(){
        ...
        recyclerView = findViewById(R.id.rcv_personalcare);
        database = db.getReference("CPersonalCare");
