...
public class CMomAndBaby extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cmom_and_baby);
    ...
    public void getProducts(){
        ...
        recyclerView = findViewById(R.id.rcv_momandbaby);
        database = db.getReference("CMomAndBaby");
