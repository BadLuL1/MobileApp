...
public class CAutoAccessory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cauto_accessory);
    ...
    public void getProducts(){
        ...
        recyclerView = findViewById(R.id.rcv_autoaccessory);
        database = db.getReference("CAutoAccessory");
